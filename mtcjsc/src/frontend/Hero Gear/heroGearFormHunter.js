...
const HunterHeroGearFillIn = () => {
    ...
    const handleClickForSetHeroGear = (event) => {
        ...
        // console.log(`Inside handleClickForSetHeroGear : ${setCurrentHunterGear} and ${event.target.value};` )
        ...
        <div>
            ...
            <form >
                <label>
                    ...
                    <select value = {currentHunterGear} onChange = {handleClickForSetHeroGear}>
                 ...
                 <label>
                    Select your current hunter hero gear level:
                    <select value = {currentChooseHunterGear} onChange = {handleClickToFindWhatNeed}>
                    <option value = "white1star" id = '1'>White 1*</option>
                    <option value = "white2star" id = '2'>White 2*</option>
                    <option value = "white3star" id = '3'>White 3*</option>
                    <option value = "green1star" id = '4'>Green 1*</option>
